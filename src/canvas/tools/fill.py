...
class FillTool(BaseTool):
    """Herramienta relleno - rellena áreas de color similar."""

    def __init__(self):
        super().__init__("Relleno", "tool-fill")
        self.tolerance = 32  # Tolerancia de color (0-255)
    ...
    def on_press(self, canvas, x, y, button=1):
        ...
        # Si el color es igual al de relleno, no hacer nada
    ...
    def _flood_fill(self, canvas, start_x, start_y, target_color, fill_color):
        """Algoritmo flood fill con tolerancia."""
        ...
        # Color de relleno en bytes BGRA
        b, g, r, a = fill_color[2], fill_color[1], fill_color[0], fill_color[3]

        pixels_changed = 0
        max_pixels = width * height  # Límite de seguridad
    ...
    def _color_matches(self, color1, color2):
        """Verifica si dos colores están dentro de la tolerancia."""
